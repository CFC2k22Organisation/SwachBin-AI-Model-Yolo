# -*- coding: utf-8 -*-
"""Recycled Trash Classification.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QU16piymO2e1Y3sJdglafxPwl3N__Fpd
...
We will use the <a href="https://universe.roboflow.com/ra9mgk-yandex-ru/trash-lgob8" target="_blank">Trash Images</a> dataset for training the custom YOLOv5 object detector.

Let's download the dataset.
"""

if not os.path.exists('train'):
    !curl -L "https://universe.roboflow.com/ds/c1EfF4SCFy?key=uh9ALN6p1y" > roboflow.zip; unzip roboflow.zip; rm roboflow.zip
...
The dataset contains 7 classes: **'Bottle', 'Box', 'Butt', 'Cap', 'Cup', 'Pipe', 'Wrapper'**.
...
nc: 7
names: ['Bottle', 'Box', 'Butt', 'Cap', 'Cup', 'Pipe', 'Wrapper']
```
